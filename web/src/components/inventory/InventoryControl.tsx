...
import { faHand, faHandHoldingHand, faInfoCircle, faPause } from '@fortawesome/free-solid-svg-icons';
      ...
      <div className="inventory-control">
        <div className="inventory-control-wrapper">
          ...
          <button className="inventory-control-button" ref={give}>
            {<FontAwesomeIcon icon={faHandHoldingHand} /> || 'Give'}
          </button>
          <button className="inventory-control-button" onClick={() => fetchNui('exit')}>
            {<FontAwesomeIcon icon={faPause} /> || 'Close'}
          </button>
        </div>
      </div>
